  ...
  <?php if (!empty($weddingResults)): ?>
    <?php foreach ($weddingResults as $row): ?>
      <div class="request-card">
        ...
        <p>Declined Reason: <?= htmlspecialchars($row['decline_reason']) ?></p> <br>
        <a href="user.declined.details.wedding.php?id=<?= urlencode($row['wedding_applications_id']) ?>" class="view-more-btn">View More</a>
      </div>
    <?php endforeach; ?>
  <?php else: ?>
  ...
  <?php if (!empty($burialResults)): ?>
    <?php foreach ($burialResults as $row): ?>
      <div class="request-card">
        ...
        <p>Declined Reason: <?= htmlspecialchars($row['decline_reason']) ?></p> <br>
        <a href="user.declined.details.burial.php?id=<?= urlencode($row['burial_requirements_id']) ?>" class="view-more-btn">View More</a>
      </div>
    <?php endforeach; ?>
  <?php else: ?>
